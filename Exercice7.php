...
$query = 'SELECT `id`, `lastName`, `firstName`, DATE_FORMAT(`birthDate`, "%d/%m/%Y") AS `birthDate`, CASE WHEN `card` = 0 THEN \'Non\' WHEN `card` = 1 THEN \'Oui\' END AS `card`, `cardNumber` FROM `clients`';
